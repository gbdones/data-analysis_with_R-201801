...
#'Adicione uma nova variável determinando, para cada UF, se a média é maior ou menor que a mediana. Ao final, exiba a quantidade de UFs onde a mediana foi maior que a média.
...
subset_salarios %>% 
    mutate(desvio_padrao = sd(REMUNERACAO_REAIS))
```
